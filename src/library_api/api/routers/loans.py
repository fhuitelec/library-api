...
from library_api.api.security.authorization import requires_permissions
...
@router.post("/approve")
@requires_permissions(required={Permission.LOAN_APPROVE})
async def approve_loan(jwt: Annotated[JWT, Depends(authentication)], loan_id: uuid.UUID) -> Loan:
    """Request a new loan for a book."""
